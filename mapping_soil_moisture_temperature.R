...
soil_temperatureData <- 'C:/Users/smdevine/Desktop/rangeland project/results/processed_soil_moisture/Apr2017/daily_by_location/Temperature'

#test for autocorrelation using spdep package (create function out of this later)
#define working directory, either VWC or soil temperature
data_dir <- soil_temperatureData
setwd(data_dir)
