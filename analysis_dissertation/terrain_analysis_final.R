...
png(file = file.path(results, 'figures', 'finals', 'peak2017.vs.2018.forage.v3.png', sep = ''), family = 'Book Antiqua', width = 800, height = 700, units = 'px', res=100)
...
legend(x=2800, y=1625, legend=(c("< 1254", '1254-1458', '>1458')), pch=19, pt.cex = c(1.5, 1.5, 1.5), col=c('blue', 'orange2', 'red3'), title = expression(paste('annual kWh ', m^2))) #3 color energy legend
legend(x=3500, y=1625, legend=(c("concave", 'linear', "convex")), pt.cex=c(1, 1.5, 2.5), pch=c(1, 1, 1), col=c('black', 'black', 'black'), title = 'Mean curvature')
text(x=4000, y=650, label=paste('% slope 26', '\u00B1', '9'))
text(x=4000, y=600, label=paste('elev 485', '\u00B1', '8'))
text(x=4000, y=1350, label=paste('% slope 17', '\u00B1', '6'))
text(x=4000, y=1300, label=paste('elev 490', '\u00B1', '10'))
text(x=2000, y=1375, label=paste('% slope 20', '\u00B1', '7'))
text(x=2000, y=1325, label=paste('elev 496', '\u00B1', '6'))
text(x=2000, y=650, label=paste('% slope 26', '\u00B1', '10'))
text(x=2000, y=600, label=paste('elev 488', '\u00B1', '6'))
